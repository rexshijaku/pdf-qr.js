var QR_JS = require('jsqr');
var PDF_JS = require("pdfjs-dist/legacy/build/pdf.js");
const {createCanvas} = require('canvas')

PDF_JS.GlobalWorkerOptions.workerSrc = './pdf.worker.min.js';
...
var PDF_QR_JS = (function () {
    ...
    function getPageAsImg(canvas, scaled) {
        ...
        if (scaled === 1) {
            var imgToBePrinted = createCanvas();
    ...
    function decoder(params) {
        ...
        PDF_JS.getDocument(getDocumentUrl(params)).promise.then(function (pdf) {
